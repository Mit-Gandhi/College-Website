      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Emerging Technologies and Recent Advancements in Engineering and Technology - Bringing together researchers, 
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 Emerging Technologies and Recent Advancements in Engineering and Technology. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
